...
view_bt_report		= 7		--战斗中-战斗经验结算
view_bt_waiting		= 8		--战斗中-打捞老婆
view_bt_get_waifu	= 9		--战斗中-捞到老婆
view_bt_next		= 10	--战斗中-下一波
view_bt_moving		= 11	--战斗中-赶路到下一波
...
timeout_count_default	= 10	--默认执行10次超时